<?php include('header.php'); ?>
     <section class="home-hero-section-one wf-section" style="background-image: url('./assets/images_new/bg-final.png');background-size: cover;background-position: 0 0">
              ...
              <div class="home-hero-caption-block">
                 ...
                 <div class="overflow-off">
                    <div class="users-count-block-two">
                          <div class="home-page-creative-list-block"><div class="home-page-creative-check-icon"><img src="./assets/images_new/check.png" loading="lazy" alt="Check" class="checked-icon-blue-circle"></div><p class="creative-text-list-content"><span class="creative-list-span-text-content">No platform fees, no subscriptions! </span><br> Explore Make Opinion platform with no payment required!</p></div>
