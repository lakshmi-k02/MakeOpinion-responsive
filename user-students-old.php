...
<!-- Mobile Hero Section  -->
<section class="home-hero-section-one wf-section moible-only" style="background: #fff; padding-bottom: 170px; padding-top: 100px; background-image: url('./assets/images_new/bg-final.png'); background-size: cover; background-position: 0 0;">
    <div class="home-hero-container-large w-container">
        <div class="home-hero-main-block">
            <div class="home-hero-caption-block">
                <div class="overflow-off">
